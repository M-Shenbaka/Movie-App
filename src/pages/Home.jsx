...
const Home = ()=>
{
    ...
    useEffect(()=>
    {
        let url   = `https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=7bc77b4ec18c2480775d0a1c129a577c`;

        if(search)
        {
            url = `https://api.themoviedb.org/3/search/movie?query=${search}&api_key=7bc77b4ec18c2480775d0a1c129a577c`;
        }
    ...
    return(
        <div className="p-4 pt-16">
            ...
            <div className="pagination-container flex justify-between mt-4">
                ...
                <button className="bg-gray-900  text-white rounded p-2"onClick={()=>
                    {
                        setPage(current => current + 1);
                    }
                }>Next</button>
